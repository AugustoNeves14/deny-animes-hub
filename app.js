...
// Removido pelo script: // Removido pelo script: // Removido pelo script: // Removido pelo script: app.use('/uploads', express.static(path.join(__dirname, 'public/uploads'))); // Imagens agora são servidas do DB. // Imagens agora são servidas do DB. // Imagens agora são servidas do DB. // Imagens agora são servidas do DB.
